...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accion']) && isset($_POST['usuario']) && in_array($_POST['usuario'], $clientesAsignados)) {
...
foreach ($contenido as $linea) {
    $comanda = Comanda::fromCSV($linea);
    if ($comanda && in_array($comanda->usuario, $clientesAsignados)) {
        echo "<tr>";
        ...
        echo "<td>
            <form method='post' style='display:inline;'>
                ...
                <input type='hidden' name='usuario' value='" . htmlspecialchars($comanda->usuario) . "'>
